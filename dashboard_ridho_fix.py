...
st.sidebar.markdown("**• Nama: Ridho Derri Safutra**")
st.sidebar.markdown(
    "**• Email: [derrisafutra.07@gmail.com](derrisafutra.07@gmail.com)**")
st.sidebar.markdown(
    "**• Dicoding: [ridhosafutra21](https://www.dicoding.com/users/ridhosafutra21/academies)**")
